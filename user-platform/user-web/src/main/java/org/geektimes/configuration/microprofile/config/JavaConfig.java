...
import org.geektimes.configuration.microprofile.config.convert.ConverterSupport;
...
public class JavaConfig implements Config {
    ...
    private final ConverterSupport converterSupport;
    ...
    public JavaConfig() {
        this.converterSupport = new ConverterSupport();
    ...
    public <T> T getValue(String propertyName, Class<T> propertyType) {
        ...
        // String 转换成目标类型
        Converter<T> converter = converterSupport.getConverter(propertyType);
    ...
    public <T> Optional<Converter<T>> getConverter(Class<T> forType) {
        return Optional.ofNullable(converterSupport.getConverter(forType));
    }
    ...
    public void setConverter(Class<?> requiredType, Converter converter) {
        converterSupport.setConverter(requiredType, converter);
    }
}

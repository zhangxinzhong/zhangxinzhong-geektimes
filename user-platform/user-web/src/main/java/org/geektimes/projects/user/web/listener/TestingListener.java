...
//        logger.info("]");
    ...
    private void testConfig(ComponentContext context) {
       JavaConfig config =  context.lookupComponent("java/Config");
       logger.info("config:["+config.getValue("application.name",String.class)+"]");
    }
